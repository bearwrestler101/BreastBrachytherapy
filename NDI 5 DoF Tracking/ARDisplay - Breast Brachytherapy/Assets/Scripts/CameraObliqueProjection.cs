...
public class CameraObliqueProjection : MonoBehaviour
{
    ...
    void OnPreCull()
    {
        ...
        if (null != projectionScreen && null != cameraComponent)
        {
            ...
            /*if (mirrorCamera)
            {
                cameraComponent.projectionMatrix = cameraComponent.projectionMatrix * Matrix4x4.Scale(new Vector3(-1, 1, 1)); //Works
            }*/
